...
# Enable lightdm since EPEL packages it disabled by default
...
PLASMA_SESSION_FILE="plasma"

if [ -f /usr/share/wayland-sessions/plasmawayland.desktop ]; then
  PLASMA_SESSION_FILE="plasmawayland"
  # LightDM friendly link
  ln -s /usr/share/wayland-sessions/plasmawayland.desktop /usr/share/xsessions/plasmawayland.desktop
fi
