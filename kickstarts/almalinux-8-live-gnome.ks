...
# Repos
url --url=http://atl.mirrors.knownhost.com/almalinux/8/BaseOS/$basearch/os/
repo --name="appstream" --baseurl=http://atl.mirrors.knownhost.com/almalinux/8/AppStream/$basearch/os/
repo --name="extras" --baseurl=http://atl.mirrors.knownhost.com/almalinux/8/extras/$basearch/os/
repo --name="powertools" --baseurl=http://atl.mirrors.knownhost.com/almalinux/8/PowerTools/$basearch/os/
