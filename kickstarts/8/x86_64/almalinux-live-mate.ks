...
# Repos
url --url=https://aws.repo.almalinux.org/8/BaseOS/$basearch/os/
repo --name="appstream" --baseurl=https://aws.repo.almalinux.org/8/AppStream/$basearch/os/
repo --name="extras" --baseurl=https://aws.repo.almalinux.org/8/extras/$basearch/os/
repo --name="powertools" --baseurl=https://aws.repo.almalinux.org/8/PowerTools/$basearch/os/
